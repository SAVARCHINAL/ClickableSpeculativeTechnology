...
function Clickable() {
	...
	this.stroke = "#9BA2F9";	//Border color of the clickable
	this.text = "Press Me";		//Text of the clickable
	this.textColor = "#9BA2F9";	//Color for the text shown
	this.textSize = 18;		//Size for the text shown
	this.textFont = "Times New Roman";	//Font for the text shown
